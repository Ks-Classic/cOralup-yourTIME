...
| 1.2 | LIFF作成 | 同チャネル内でLIFFアプリ追加（ログイン専用） | 📋 | 10min |
| 1.3 | Webhook URL設定 | `/api/line/staff-webhook` を登録 | 📋 | 5min |
| 1.4 | リッチメニュー作成 | 「アプリを開く」→ LIFF URL | 📋 | 15min |
| 1.5 | 環境変数設定 | Vercel + ローカルに追加 | 📋 | 10min |

...
| Phase | 機能 | 状態 |
|-------|------|------|
| Phase 1.5 | **イベント登録フロー** — 友だち追加時にイベント選択、`event_staffs`で管理 | ✅ 実装済み |
| Phase 2 | スタッフへの通知（対応完了時） | 📋 未着手 |
| Phase 3 | リーダー向け全員履歴閲覧 | 📋 未着手 |
| Phase 4 | トレーナー向けLINE統合 | 📋 未着手 |

### Phase 1.5: イベント登録フロー（2026-02-16 追加）

**詳細仕様書**: [38-スタッフイベント登録フロー仕様書.md](38-スタッフイベント登録フロー仕様書.md)

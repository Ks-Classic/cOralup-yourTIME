            ...
            <div className="grid grid-cols-2 gap-1.5">
              {item.options?.map(option => (
                <div
                  ...
                  onClick={() => !isReadOnly && updateDiagnosisValue(item.id, option.value)}
                  className={cn(
                    'flex items-center justify-center p-2.5 border-2 rounded-lg transition-all touch-manipulation min-h-[44px] font-medium select-none',
                    !isReadOnly ? 'cursor-pointer' : 'cursor-default opacity-80',
                    value === option.value
              ...
              <Card className="shadow-sm">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    {!isEditingQuestionnaire && !isReadOnly ? (
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => {
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="pt-2">
                            ...
                            <Button
                              onClick={runAnalysis}
                              disabled={isAnalyzing || !canAnalyze || isReadOnly}
                              className={cn(
                                "w-full",
                                canAnalyze && !isReadOnly ? "bg-coral-500 hover:bg-coral-600" : "bg-gray-300"
                              )}
                              size="lg"
                            >
                              {isAnalyzing ? (
                  ...
                  <Card className="shadow-sm">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <ReportPreview
                        ...
                        isEditable={!isReportConfirmed && !isReadOnly}

...
export default function SessionDetailPage({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  ...
  useEffect(() => {
    ...
    const mockSession: SessionData = {
      id: sessionId,
      session_id: sessionId.startsWith('SESSION') ? sessionId : `SESSION${sessionId}`,
      status: sessionId === '1' ? 'questionnaire_completed' : 'active',
      parent_name: '保護者 太郎',

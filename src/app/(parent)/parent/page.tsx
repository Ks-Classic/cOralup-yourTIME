                ...
                <div className="flex-1">
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 mb-2">
                    ...
                    <button
                      ...
                      className="bg-coral-500 hover:bg-coral-600 text-white rounded-lg p-3 text-center w-full transition-colors cursor-pointer"
                      type="button"
                    >
                      <p className="text-sm font-medium">診断を開始する</p>
                    </button>
                  </div>

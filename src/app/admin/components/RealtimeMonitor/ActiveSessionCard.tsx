                ...
                <div className="col-span-3">
                    ...
                    <div className="text-sm text-slate-500 mt-1 flex items-center gap-2 flex-wrap">
                        {session.parentLineDisplayName && (
                            <span className="inline-flex items-center gap-1 text-xs text-green-600 bg-green-50 px-1.5 py-0.5 rounded whitespace-nowrap">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <div className="text-xs text-slate-500 mt-1 flex items-center gap-2 flex-wrap">
                            {session.parentLineDisplayName && (
                                <span className="inline-flex items-center gap-0.5 text-[10px] text-green-600 bg-green-50 px-1 py-0.5 rounded">
